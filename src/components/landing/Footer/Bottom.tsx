    ...
    return (
        <div className='py-[5rem] px-[3rem]'>
            <div className='flex flex-col mdl:flex-row justify-between'>
                <div className='max-w-[20rem] flex flex-col self-center items-center mdl:self-start mdl:items-start text-textGray'>
                    <Link
                        href=''
                        className='flex flex-row items-center gap-2 h-[2.25rem] mb-6'
                    >
                        <Image
                            src={logoImg}
                            alt=''
                    ...
                    <div className='self-center py-4'>
                        <p className='text-[1em] leading-snug text-center mdl:text-left'>
                            We are fully compliant with the EU General Data
                            Protection Regulation (GDPR) and guarantee ISO 27001
                            certified server locations in Europe.
                        </p>
                    </div>
                ...
                <div className='max-w-screen grid auto-cols-[1fr] grid-cols-auto grid-rows-auto gap-x-[70px] gap-y-[40px]'>
                    <div className='flex flex-col items-start gap-y-[1rem]'>
                        ...
                        <a
                            href='/product/project-management'
                            className='text-textGray'
                        >
                            Project management
                        </a>
                        <a
                            href='/product/team-scheduling'
                            className='text-textGray'
                        >
                            Team scheduling
                        </a>
                        <a
                            href='/product/time-tracking'
                            className='text-textGray'
                        >
                            Time tracking
                        </a>
                    ...
                    <div className='flex flex-col items-start gap-y-[1rem]'>
                        ...
                        <a
                            href='/work-happiness-report'
                            className='text-textGray'
                        >
                            Work Happiness Report
                        </a>
                        <a
                            href='/legal-and-privacy/imprint'
                            className='text-textGray'
                        >
                            Imprint
                        </a>
                    ...
                    <div className='min-w-[60px] flex flex-col items-start gap-y-[1rem]'>
                        <div className='c-footer_label'>
                            <div className='text-textWhite text-[1.13em] leading-[1.45] font-bold'>
                                Support
                            </div>
