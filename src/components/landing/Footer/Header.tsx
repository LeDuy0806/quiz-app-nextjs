    ...
    return (
        <div className='flex flex-col relative text-center items-center'>
            ...
            <div className='relative flex flex-col items-center text-center justify-center gap-y-10'>
                <h2 className='text-textWhite my-0 text-[2em] mdl:text-[4em] font-extrabold leading-[1px] tracking-[-0.025em]'>
                    Trusted by more than
                </h2>
                <div className='flex flex-col mdl:flex-row items-center gap-4'>
            ...
            <div className='z-[1] relative flex mdl:flex-row mt-[7em] justify-between px-20 gap-x-5 '>
                <div className='flex flex-col items-center mdl:flex-row justify-between flex-wrap gap-5'>
                    <div className='mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                Quiz offers an outstanding user experience, with
                                its intuitive interface and smooth navigation.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                Quiz impresses with its robust feature set. From
                                customizable quizzes to detailed analytics, it
                                covers everything needed for effective learning
                                and assessment. 💪
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                This software is not only engaging but also
                                highly educational. It's a fantastic tool for
                                learning and testing one's knowledge.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                The ability to customize quizzes to align with
                                specific educational goals and branding is a
                                standout feature.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='min-w-[400px] mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                The support for various media types, such as
                                images and videos, adds a dynamic element to the
                                quizzes, making learning more engaging. 💪
                            </p>
                        </div>
                    </div>
                    <div className='mdl:max-w-[32%]'>
                        <div className='relative flex flex-col gap-y-[1.5em] text-left p-[1.5em] shadow-boxheaderfooter bg-bgDark rounded-[2.5em]'>
                            ...
                            <p className='text-left text-white'>
                                Incorporating gamification elements in quizzes
                                adds an element of fun and motivation to the
                                learning process.
                            </p>
                        </div>
                    </div>
