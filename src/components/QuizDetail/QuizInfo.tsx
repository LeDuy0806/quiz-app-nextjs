...
import { FaBook, FaBullseye, FaCopy, FaExclamationTriangle, FaFolder, FaGraduationCap, FaHeart, FaPlay, FaRegCopy, FaRegFolder, FaShare } from 'react-icons/fa';
                        ...
                        <div className='flex flex-col w-10/12 ml-3'>
                            ...
                            <div className='flex w-3/5 my-1 text-xl min-h-[3rem] text-slate-800'>
                                <div className=' flex w-full items-center'>
                                    <h1 className='text-lg font-semibold inline-block text-left align-middle overflow-hidden break-words '>Quiz title</h1>
                                </div>
                            </div>
                            {/* quiz detail section */}
                            <div className='grid grid-cols-[auto_auto_auto] [grid-row-gap:0.5rem] justify-start'>
                                ...
                                <h2 className='flex items-center'>
                                    ...
                                    <div className='flex text-slate-700 text-xs'>
                                        <span className='truncate max-w-[10rem]'>University</span>
                                    </div>
                                    <div className='flex text-slate-700 text-xs'>
