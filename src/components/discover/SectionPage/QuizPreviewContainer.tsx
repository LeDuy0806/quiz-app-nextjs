...
function QuizPreviewContainer({ quizData }: { quizData: QuizType }) {
    ...
    return (
        <div className='mx-1 my-1 border-collapse overflow-auto rounded border-slate-200'>
            <div className='relative h-fit'>
                <div className='sticky top-0 flex w-full flex-col gap-2 rounded-t bg-white  p-3 shadow'>
                ...
                {/* Body */}
                <div className='relative flex-col rounded-t bg-white'>
                    <div className='flex h-fit gap-x-2 rounded-b p-3 shadow'>
                    ...
                    <div className=' flex items-center justify-between border-b border-slate-200 bg-gray-100 p-3'>
