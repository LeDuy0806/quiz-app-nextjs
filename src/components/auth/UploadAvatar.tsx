...
import { loadingImg, uploadImg } from "../../../public/assets/images/auth";
            ...
            <div className="flex flex-col items-center justify-center rounded-lg text-center py-10 px-6 border border-dashed border-textGray gap-3">
              ...
              {file && (
                ...
                >
                  {!props.avatar ? (
                    loadingUpload ? (
                      <Image src={loadingImg} alt="" className="w-7 h-7" />
                    ) : (
                      "Upload File"
                    )
                  ) : (
      ...
      >
        <motion.button
          ...
          className={clsx(
            ...
            props.avatar && "hover:font-black bg-textGreen cursor-pointer"
          )}
