...
import { goldTrophy } from '../../../../public/assets/images/leaderboard';
...
const FirstUser = ({ user }: FirstUserProps) => (
    <div className='flex-1'>
            ...
            <div className='relative h-24 w-24 rounded-full'>
                ...
                <span className='absolute bottom-0 right-0 inline-flex items-center justify-center'>
                    <span className='relative h-10 w-10'>
                        <Image src={goldTrophy} alt='Gold' fill className='object-cover object-center' />
                    </span>
                </span>
            </div>
        ...
        <div className='h-0 w-full border-b-[0.75rem] border-l-[0.75rem] border-r-[0.75rem] border-solid border-b-bgPurplePower border-l-transparent border-r-transparent'></div>

        <div className='flex h-36 items-center justify-center bg-gradient-purple'>
