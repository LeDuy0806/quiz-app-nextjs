...
function QuestionCard({ questionData, isShowAnswer }: { questionData: QuestionType; isShowAnswer: boolean }) {
    return (
        <div className='mb-4 flex cursor-pointer flex-col rounded-lg border border-solid border-slate-200 bg-white hover:bg-gray-100'>
